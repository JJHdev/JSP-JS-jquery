...
public class DBCPInitListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		/* web.xml문서에서 > context-param에서 해당하는 역할 */
		String poolConfig = 
...
*/
```
#### 1-3. dbconnection, dbtest설정
 1-3-1. dbconnectionProvider 설정
```
package jdbc.conn;
...
//web.wml문서에서 설정한 poolName=board으로 지정한 board를
//풀이름으로 사용하여 connection을 제공하는 클래스이다.
